	...
	<body>
	    ...
	    <div class="sidenav">
	        <ul>
				...
				<br>
				<br>
				<li><a href="doctorappoinmentpendingpage1.php"><i class="fa fa-user-o"></i>&nbsp Appointment Pending</a></li>	
				<br>
				<br>
				<li><a href="doctordiseasepredictorpage1.php"><i class="fa fa-tachometer"></i>&nbsp Disease Predictor </a></li>
				<br>
				<br>
				<li><a href="doctorupdateavailabilitypage1.php"><i class="fa fa-refresh"></i>&nbsp Update Availability</a></li>				
	        </ul>
	    </div>
	</body>
</html>