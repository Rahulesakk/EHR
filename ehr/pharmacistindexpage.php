	...
	<html>
	    ...
	    <body>
            <div class="adminheader" style="position:fixed;top:0px;left:0px;width:100%;height:61px;background-color:#3c4545">
	            <div>
	                <h1  style="position:fixed;font-size:28px;color:#34ebe8;">&nbsp &nbsp EHR Based Healthcare System | Pharmacist</h1>  
	            </div>
	            <div>
	        ...
	        <div class="sidenav">
	            <ul>
                    ...
                    <br>
                    <br>
                    <li><a href="pharmacistprescribelist.php"><i class="fa fa-h-square"></i></i></i>&nbsp Prescribe List</a></li>	
                    <br>
                    <br>	
                    <li><a href="pharmacistviewdrugs.php"><i class="fa fa-medkit"></i></i>&nbsp View Drugs</a></li>							
                    <br>
                    <br>
					<li><a href="pharmacistdrugadd.php"><i class="fa fa-plus-square"></i></i>&nbsp Add Drug</a></li>	
					<br>
				    <br>
				</ul>
	        </div>
