<?php
	...
	$sql="SELECT * FROM login where id='1' and username='$name' and password='$passwd'";
	$result=mysqli_query($conn,$sql);
	$row=mysqli_fetch_array($result,MYSQLI_ASSOC);
	if(mysqli_num_rows($result)==1)
		{
			header("location:receptionistindexpage.php");
		}
	else
		{
			header("location:receptionistloginpage.php");
		}
?>