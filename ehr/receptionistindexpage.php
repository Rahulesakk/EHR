...
<html>
	...
	<body>
     <div class="adminheader" style="position:fixed;top:0px;left:0px;width:100%;height:61px;background-color:#3c4545">
	    <div>
	        <h1  style="position:fixed;font-size:28px;color:#34ebe8;">&nbsp &nbsp EHR Based Healthcare System | Receptionist</h1>  
	    </div>
	    <div>
	...
	<div class="sidenav">
	    <ul>
			...
			<br>
			<br>
			<li><a href="receptionistbookappointmentpage1.php"><i class="fa fa-user-o"></i>&nbsp Book Appointment</a></li>	
			<br>
			<br>	
	    </ul>
	 </div>
