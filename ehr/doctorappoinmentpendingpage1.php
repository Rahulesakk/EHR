            	...
            	<div style="width:1150px;height:425px;border:0.5px solid #c2c2a3;padding:25px;margin:10px;background-color:white;">
					<h1>Patient List</h1>
						...
						<table  border="1" cellspacing="0">
						    ...
						    <tbody>
<?php
 $sql = "SELECT * FROM adharcarddetails as ad INNER JOIN appointment as ap ON ad.adharcardnumber=ap.adharcardnumber INNER JOIN history as hs ON ad.adharcardnumber=hs.adharcardnumber  where roomthatalloted='Room1'";
...
<?php $adcno=$result->adharcardnumber;?>
								<form action="doctorexampage1.php" method="post" >
								...
								<form action="doctorprescribepage1.php" method="post" >
