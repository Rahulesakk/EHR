    ...
    <html>
        ...
        <body>
            <div>
                ...
                <form action="adminloginpagephp.php" method="post" >
                    <br>
                    <br>
                    <br>
                    <br>
                    <br>
                    <br>
	                <input style="position:relative;right:600px;top:1px;" type="text" id="name" name="username" placeholder="Enter The Admin Username" required>
                    <br>
                    <br>
                    <br>
                    <br>
                    <br>
                    <input style="position:relative;right:600px;top:1px;" type="password" id="password" name="password" placeholder="Enter The Admin Password" required>
                    <br>
                    <br>
                    <br>
                    <br>
